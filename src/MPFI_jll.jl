...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MPFI_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e8b5fb6c-218f-5c08-bc3d-6b0e551bbffd"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MPFI", artifacts_toml) for e in artifacts["MPFI"]]
...
if best_platform === nothing
    @debug("Unable to load MPFI; unsupported platform $(triplet(platform_key_abi()))")
else
